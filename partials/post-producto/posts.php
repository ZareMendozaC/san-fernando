    ...
    <div class="container d-flex">
        <div class="col-817 center-vertical">
            <div>
                ...
                <h2 class="color-blue">Encuentra <br>soluciones de cocina <br> con nuestro productos</h2>
                <p class="p-subtitle color-gris">Obtén variadas recetas y valiosos consejos nutricionales creados para ti y tu familia.</p>
